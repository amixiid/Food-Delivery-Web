...
const Login = () => {
    ...
    return (
        <div className="min-h-[80vh] flex items-center justify-center px-4 py-12 relative overflow-hidden bg-slate-50 dark:bg-slate-950 transition-colors duration-300">
            {/* Background Decor */}
            ...
            <div className="max-w-md w-full relative z-10">
                <div className="bg-white dark:bg-slate-900 shadow-2xl dark:shadow-green-500/5 rounded-[2.5rem] border border-gray-100 dark:border-slate-800 p-8 md:p-10 transition-all duration-300">
                    <div className="text-center mb-10">
                        <div className="inline-flex items-center justify-center w-20 h-20 bg-green-50 dark:bg-green-500/10 rounded-2xl mb-6 shadow-inner">
                            <UtensilsCrossed size={40} className="text-green-500" />
                        </div>
                        <h2 className="text-3xl font-black text-gray-900 dark:text-white tracking-tight">Welcome Back</h2>
                        <p className="text-gray-500 dark:text-gray-400 mt-3 font-medium">Login to continue ordering 🍕</p>
                    </div>

                    <div className="bg-green-50/50 dark:bg-green-500/5 border border-green-100/50 dark:border-green-500/10 rounded-2xl p-4 mb-8 text-sm text-green-700 dark:text-green-400 flex items-center gap-3">
                        <span className="flex-shrink-0 w-8 h-8 flex items-center justify-center bg-white dark:bg-slate-800 rounded-lg shadow-sm font-bold text-[10px] tracking-tighter">DEMO</span>
                        <p className="font-medium">admin@fooddash.com / password123</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full btn-primary py-4 text-base font-bold disabled:opacity-60 mt-4 h-14"
                        >
                            {loading ? (
                    ...
                    <div className="mt-8 text-center text-gray-500 dark:text-gray-400 text-sm">
                        ...
                        <Link to="/register" className="text-green-500 font-bold hover:underline ml-1 uppercase tracking-wider text-xs">Sign Up</Link>
                    </div>
                </div>
            </div>
        </div>
